 ...
 * Descript:基于jquery，开发一些网站页面中用到的小组件，方便维护和运用; 图片轮播
    ...
    $.extend($.fn,{
        doImages:function(options){
            ...
            function imgsPlay(obj){
                ...
                $(opts.imgs).css({
                    display:"block"
                }).removeClass("imgBlock").css("z-index","1").eq(s).attr("class","imgBlock").css("z-index","2").stop(!0,!0).animate({opacity:"+=1"},300,function(){
